...
<section class="mb-16">
    ...
    <div class="mb-8 w-full bg-blue-500 py-16"><h2 class="m-auto w-3/5 text-center text-4xl font-bold text-white">A Sophomore Computer Science Student Bridging Code and Creativity</h2></div>
    <ProseArticle>
