export interface SocialMediaSvg {
    link: string;
    viewbox: string;
    path: string;
}

export const socialMediaSvgs: SocialMediaSvg[] = [
    // instagram
    {
        link: "https://www.instagram.com/coltgause._/",
        viewbox: "0 0 448 512",
    ...
    // mail
    {
        link: "mailto:a.gause@outlook.com",
        viewbox: "0 0 512 512",
    ...
    // github
    {
        link: "https://github.com/AustinCGause",
        viewbox: "0 0 496 512",
